    ...
    <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 pb-20">
        <div class="bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-200">
            <div class="bg-gray-50 p-6 flex justify-between items-center border-b">
                <div class="text-center font-bold">Raja CA</div>
                <div class="text-green-600 font-black italic text-xl underline decoration-double">VS</div>
                <div class="text-center font-bold">Wydad AC</div>
            </div>
            <div class="p-6">
                <div class="space-y-3 mb-6">
                    <p class="text-gray-600 text-sm"><i class="fas fa-calendar mr-2"></i> 25 Juin 2025 - 20:00</p>
                    <p class="text-gray-600 text-sm"><i class="fas fa-map-marker-alt mr-2"></i> Stade Mohamed V</p>
                    <p class="text-green-700 font-bold">À partir de 50 DH</p>
                </div>
                <a href="match_details.php" class="block w-full text-center bg-gray-900 text-white py-3 rounded-xl font-bold hover:bg-black transition">Réserver</a>
            </div>
        </div>
    </div>
</body>
